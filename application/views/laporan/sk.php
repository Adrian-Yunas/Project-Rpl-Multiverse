                    ...
                    if (res.status) {
                        ...
                        if (res.data.length > 0) {
                            $.each(res.data, function(key, val) {
                                ...
                                content += '<td><table class="table-borderless"><tr><td><b>Nama Mitra</b></td><td>:</td><td>' + val.no_agenda + '</td>';
                                content += '</tr><tr><td><b>Alamat Mitra</b></td><td>:</td><td>' + val.pengirim + '</td></tr>';
