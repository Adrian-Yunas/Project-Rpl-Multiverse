                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="no_agenda">Nama Mitra</label>
                                <input type="text" name="no_agenda" id="no_agenda" class="form-control" value="<?= set_value('no_agenda'); ?>">
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="form-group">
                                <label for="pengirim">Alamat Mitra</label>
                                <input type="text" name="pengirim" id="pengirim" class="form-control" value="<?= set_value('pengirim') ?>">
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="form-group">
                                <label for="no_surat" hidden> No. Surat</label>
                                <input type="text" name="no_surat" id="no_surat" class="form-control" value="<?= set_value('no_surat') ?>" hidden>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="invalid-feedback"></div>
                            <div class="form-group">
                                <label for="tgl_diterima" hidden>Tanggal Diterima</label>
                                <input type="date" name="tgl_diterima" id="tgl_diterima" class="form-control" value="<?= set_value('tgl_diterima') ?>" hidden>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="form-group">
